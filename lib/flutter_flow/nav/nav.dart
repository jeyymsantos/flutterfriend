...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => const MachineLearningWidget(),
        ),
        FFRoute(
          name: 'tensorlite',
          path: '/tensorlite',
          builder: (context, params) => const TensorliteWidget(),
        ),
        FFRoute(
          name: 'QRPage',
          path: '/qRPage',
          builder: (context, params) => const QRPageWidget(),
        ),
        FFRoute(
          name: 'GenerateQR',
          path: '/generateQR',
          builder: (context, params) => const GenerateQRWidget(),
        ),
        FFRoute(
          name: 'ScanQR',
          path: '/scanQR',
        ...
        FFRoute(
          name: 'ViewQR',
          path: '/viewQR',
          builder: (context, params) => ViewQRWidget(
            qrText: params.getParam(
              'qrText',
              ParamType.String,
            ),
            qrDateTime: params.getParam(
              'qrDateTime',
              ParamType.DateTime,
            ),
            qrType: params.getParam(
              'qrType',
              ParamType.String,
            ),
          ),
